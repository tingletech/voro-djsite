...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'MosaicMember'
        db.create_table('themed_collection_mosaicmember', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('collection', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['themed_collection.ThemedCollection'])),
            ('member', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['xtf.ARKSetMember'])),
            ('order', self.gf('django.db.models.fields.IntegerField')()),
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('themed_collection', ['MosaicMember'])


    def backwards(self, orm):
        
        # Deleting model 'MosaicMember'
        db.delete_table('themed_collection_mosaicmember')
