...
CDL.DSC.OAC.mapns = function() {
    ...
    make_ark_object_label: function (ark, arkobject) {
            ...
            label = label + '<img src="' + arkobject.thumbnail.src + '" width="' + w_img + 'px" height="' + h_img + 'px" onClick="mapns.openContentPanel(\'' + ark + '\',\''+ arkobject.image + '\');return false;" onmouseover="this.style.cursor=\'pointer\';"</img>';
