...
function startRichText(event,scope,params) {
    ...
    myEditor.on('toolbarLoaded', function() {
        var insertTemplate1 = {
            type: 'push', label: 'Insert Template 1', value: 'inserttemplate1'
        };
        this.toolbar.addButtonToGroup(insertTemplate1, 'insertitem');

        this.toolbar.on('inserttemplate1Click', function() {
            this.execCommand('inserthtml', '<b>This is the text to insert.</b> Put a few nice article templates here... & make it a drop down for "layout"');
        }, this, true);
