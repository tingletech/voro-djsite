...
class RichTextWidget(forms.TextInput):
   ...
   class Media:
        css = {
            'all': ('http://yui.yahooapis.com/2.6.0/build/assets/skins/sam/skin.css', '/site_media/richtext/css/richtext.css',)
        }
        js = (
            ...
            '/site_media/richtext/js/CleanPaste.js',
            '/site_media/richtext/js/richtext.js',
            )
